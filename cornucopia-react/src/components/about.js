        ...
        <>
            <div className='about-wrap'>
                ...
                <div className='par-wrap'>
                    <p className='first-par'>We believe that people have a desire to reach out and help this world and their fellow man. Sometimes we just get in our own way. Our lives are so busy that it is difficult to find the time to search for a cause and then, to find out how and where to donate. Cornucopia is here to help with this.</p>
